    ...
    , ui(new Ui::MainWindow)
{
    ...
    connect(&model,&Model::updateTimeLabel,this,&MainWindow::updateTimeLabel);
...
/**
 * @brief MainWindow::on_fireworksButton_clicked currently used as a test method.
 */
void MainWindow::on_fireworksButton_clicked()
{
    //setSoundFile("a");
    //efx->play();
}
...
void MainWindow::displayLevel(QVector<Character> levelCharacters, int levelNum ){
    ...
    std::cout << "Recieved: " << levelNum << std::endl;
    ...
    if((levelNum+1)%5-(levelNum/6)!=0){
        ...
        for(int i=0;i<10;i++){
            ...
            case 0:
            {
                ...
                button1->setStyleSheet((QString("QPushButton {background-color: rgb(25,255,178); border-color: rgb(255, 255, 255); "
...
/**
 * @brief MainWindow::updateTimeLabel will be used in keeping track
 * of the user's best times in each level.
 * @param time current best time.
 */
void MainWindow::updateTimeLabel(int time){
    //    if(time==-1){
    //        ui->bestTimeLabel->setText("Complete Level for Best Time");
    //    }else{
    //        QString s="Best Time: " ;
    //        s.append(QString::number(time));
    //        ui->bestTimeLabel->setText(s);
    //    }
}
